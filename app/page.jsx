  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <div className="text-center">
        ...
        <p className="text-white text-lg">Redirecting to products...</p>
      </div>
    </div>
  );
};
...
// import { testimonials } from "../src/data/products";
...
//       description:
//         "Only the finest tech products that meet our rigorous standards",
//     },
//     {
//       icon: Truck,
//       title: "Fast Shipping",
//       description:
//         "Free express delivery on orders over $500, worldwide coverage",
//     },
//     {
//       icon: HeadphonesIcon,
//       title: "24/7 Support",
...
//             >
//               Discover premium technology that transforms your digital
//               experience. From cutting-edge smartphones to revolutionary
//               laptops, we curate only the finest.
//             </motion.p>
...
//             >
//               <Button onClick={handleNavigateToProducts} className="group">
//                 Explore Collection
//                 <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
//               </Button>

//               <Button variant="secondary" onClick={handleScrollToFeatured}>
//                 View Featured
//               </Button>
//             </motion.div>
//           </div>
...
//               Handpicked premium devices that represent the pinnacle of
...
//           >
//             <Button onClick={handleNavigateToProducts} variant="secondary">
//               View All Products
